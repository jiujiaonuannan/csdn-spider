...
def gen_signature(url, accept, nonce_str, cakey, secrectKey):
...
def get_html(url):
  ...
  headers = {
    ...
    # 'x-ca-signature': gen_signature(url, accept, nonce_str, cakey, app_secrect),
...
get_html("https://bizapi.csdn.net/community-cloud/v1/homepage/community/by/tag?deviceType=PC&tagId=2")
