...
def extract_topic(data_list):
  ...
  for value in data_list:
    ...
    executor.submit(parse_author, f'https://blog.csdn.net/{content["username"]}')
...
def parse_list(url):
  ...
  if title_search:
    ...
    executor.submit(extract_topic, data["pageData"]["data"]["baseInfo"]["dataList"][0:10])
